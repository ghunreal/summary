...
enum MoveingState
{
	DT_CROWDAGENT_MOVE_NONE = 0,
	DT_CROWDAGENT_MOVE_START,
	DT_CROWDAGENT_MOVE_STOP,
};
...
struct dtCrowdAgent
{
	...
	unsigned char moveState;			///< whether agent is moving
	...
	int ncollide;						///< collide level. <=0 do not collide
};
